...
You can install the development version of `smartabaseR` from [GitHub](https://github.com/Teamworksapp/smartabaseR/) with:
...
`smartabaseR` relies on features that only exist on **v6.14+** of Smartabase. If your account has `superadmin` or `site owner` privileges, then `smartabaseR` can also be used with sites on **v6.13+** of Smartabase.
