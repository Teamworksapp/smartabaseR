...
cli::cli_alert_success("Successfully logged example.username into example.smartabase.com/site.")
cli::cli_alert_success("User details export successful.")      
cli::cli_alert_success("Training Log export successful (Mar 03 2020 - Mar 07 2023).")
```
