# Contributing to smartabaseR

We welcome any and all contributions to smartabaseR! Here are some
guidelines to help make it easier to merge your pull request (credit to
the [tidyverse contribution
guidelines](https://dplyr.tidyverse.org/CONTRIBUTING.html) ):
...
Please note that the smartabaseR project is released with a [Contributor
Code of
Conduct](https://teamworksapp.github.io/smartabaseR/CODE_OF_CONDUCT.md).
