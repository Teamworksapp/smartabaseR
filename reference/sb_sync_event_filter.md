# Set filter parameters for [`sb_sync_event()`](https://teamworksapp.github.io/smartabaseR/reference/sb_sync_event.md)
...
``` r
sb_sync_event_filter(user_key = NULL, user_value = NULL)
```
